...
// const { RepoIndex, RepoAccessToken } = require('../models')
// const GithubAPI = require('github-api')
// const _ = require('lodash')
// const { getFreshIndexFromGithub } = require('./repository') // TODO: need improve
// const TaskQueue = require('../utils/TaskQueue')
// const getCollectionFiles = require('../utils/getCollectionFiles')

// const indexUpdateStrategy = commits => {
//   var combinedCommits = commits
//     .map(commit => {
...
//   var schemaUpdated =
//     _.findIndex(combinedCommits.updated, item => {
...
exports.pushHook = (req, res) => {
  ...
  //         }).then(saveIndexToDb(repository.full_name, branch))
  //       }
  //       let existingCollections = JSON.parse(
  //         record.collections
  //       ).filter(file => {
  //         return (
  //           !_.includes(strategy.removed, file.path) &&
  //           !_.includes(strategy.updated, file.path)
  //         )
  //       })
  //       let newFiles = getCollectionFiles(
  //         JSON.parse(record.schemas),
  //         strategy.updated
  //       )
