...
const debug = require('debug')('jekyllpro-cms:repository')

const config = require('../config')
const { RepoIndex, RepoAccessToken, RepoFileEntry } = require('../models')
// const TaskQueue = require('../utils/TaskQueue')
const getCollectionFiles = require('../utils/getCollectionFiles')
const getCollectionType = require('../utils/getCollectionType')
const getCMSConfigFromJekyllYaml = require('../utils/getCMSConfigFromJekyllYaml')
...
exports.getRepoDetails = (req, res, next) => {
  ...
  return repo
    ...
    .then(data => {
      ...
      details.owner = pick(data.data.owner, ['login', 'avatar_url', 'type'])
...
exports.getRepoContent = (req, res, next) => {
  const repo = req.githubRepo
...
exports.writeRepoFile = (req, res, next) => {
...
exports.deleteRepoFile = (req, res, next) => {
  var repo = req.githubRepo
...
exports.getBranchSchema = (req, res, next) => {
  var repo = req.githubRepo
...
exports.getRepoBranchIndex = (req, res, next) => {
  // var repo = req.githubRepo
...
exports.getRepoBranchUpdatedCollections = (req, res) => {
  const repo = req.githubRepo
...
exports.refreshIndexAndSave = (req, res) => {
  const repo = req.githubRepo
  const branch = req.query.branch || 'master'
  const repoFullname = req.repo.fullName
...
exports.manageHook = (req, res) => {
  var repo = req.githubRepo
  var mergedConfig = Object.assign({}, config.webhook, req.body.config || {})
...
exports.listBranchTree = (req, res) => {
  var repo = req.githubRepo
  var branch = req.query.branch || 'master'
  repo
...
function refreshIndexIncremental ({ github, repoFullname, branch }) {
  ...
  return Promise.all([
    ...
    .then(([_repoIndex, refData]) => {
      ...
      tipCommitSha = get(refData, 'data.object.sha')
...
exports.getFreshIndexFromGithub = getFreshIndexFromGithub
