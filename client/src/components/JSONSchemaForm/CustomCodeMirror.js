...
const panelButtons = [
  {
    ...
    label:
      '<svg class="icon icon-bold"><use xlink:href="#icon-bold"></use></svg><span>Bold text</span>',
  ...
  },
  {
    ...
    label:
      '<svg class="icon icon-italic"><use xlink:href="#icon-italic"></use></svg><span>Italic text</span>',
    callback: function(codeMirror) {
      var selection = codeMirror.getSelection();
      codeMirror.replaceSelection('*' + selection + '*');
      if (!selection) {
  ...
  },
  {
    ...
    label:
      '<svg class="icon icon-h1"><use xlink:href="#icon-h1"></use></svg><span>Add h1 title</span>',
    callback: function(codeMirror) {
      var selection = codeMirror.getSelection();
      codeMirror.replaceSelection('# ' + selection);
    }
  },
  {
    ...
    label:
      '<svg class="icon icon-h2"><use xlink:href="#icon-h2"></use></svg><span>Add h2 title</span>',
    callback: function(codeMirror) {
      var selection = codeMirror.getSelection();
      codeMirror.replaceSelection('## ' + selection);
    }
  },
  {
    ...
    label:
      '<svg class="icon icon-h3"><use xlink:href="#icon-h3"></use></svg><span>Add h3 title</span>',
    callback: function(codeMirror) {
      var selection = codeMirror.getSelection();
      codeMirror.replaceSelection('### ' + selection);
    }
  },
  {
    ...
    label:
      '<svg class="icon icon-ul"><use xlink:href="#icon-ul"></use></svg><span>Add a bulleted list</span>',
    callback: function(codeMirror) {
      var selection = codeMirror.getSelection();
  ...
  },
  {
    ...
    label:
      '<svg class="icon icon-ol"><use xlink:href="#icon-ol"></use></svg><span>Add a numbered list</span>',
    callback: function(codeMirror) {
      var selection = codeMirror.getSelection();
      var lines = selection.split('\n');
  ...
  },
  {
    ...
    label:
      '<svg class="icon icon-link"><use xlink:href="#icon-link"></use></svg><span>Add a link</span>',
    callback: function(codeMirror) {
      var selection = codeMirror.getSelection();
      var text = '';
      var link = 'url';
...
export default class CustomCodeMirror extends Component {
  ...
  initPanelButtons(panel, codeMirror) {
    ...
    insertBtn.innerHTML =
      '<svg class="icon icon-images"><use xlink:href="#icon-images"></use></svg><span>Insert image</span>';
