  ...
  render () {
    ...
    return (
      <section id='content' className='empty'>
        ...
        <p>
          You need to define the content types by adding "schema files" to your
          repo.
        </p>
        <button
          className={
            processing ? 'button disabled processing' : 'button primary'
          }
        ...
        <small>
          <a
            href='https://github.com/Wiredcraft/jekyllplus/wiki'
            target='_blank'
            className='readmore'
          >
            Read more about schema files
          </a>
        </small>
      </section>
    )
